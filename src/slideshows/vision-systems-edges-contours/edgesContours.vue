...
#TemperatureHeat.eg-theme-agrume
  .eg-slideshow
    ...
    slide.boredYet(enter='bounceInDown')
      ...
      p With signs of the components of the gradient, the octant is knownn, and the coordinate system and gradient vector q are rotated by π/8.
      .center
    ...
    slide.boredYet(enter='bounceInDown')
      ...
      p(style="margin: 20px 0 0 0;") Typical threshold values for 8-bit grayscale images are thi = 5.0 and tlo = 2.5.
