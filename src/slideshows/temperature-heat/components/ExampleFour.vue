    ...
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 200" height="200" width="300" >
        <g style="text-transform: none;">
          ...
          <g>
            <rect x="55" y="135" width="35" height="30" fill="white" stroke="#fff"></rect>
            <text x="55" y="159" font-size="15" fill="black">{{ Math.round(100*(0.025 * coteLine1 - 1))/100  }} cm </text>
            <animateTransform attributeName="transform" type="translate" from='10 0' :to="text1" begin="0s" dur="5s" fill="freeze"/>
          </g>
          <g>
            <rect x="190" y="135" width="35" height="30" fill="white" stroke="#fff"/>
            <text x="190" y="159" font-size="15" fill="black">{{ Math.round(100*(6 - 0.025 * coteLine1))/100 }} cm </text>
