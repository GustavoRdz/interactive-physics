...
.eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
  p.problem <strong style="color: black;">Ensuring a Tight Fit.</strong> Aluminium rivets used in airplane construction are made slightly larger than rivets holes and cooled by "dry ice" (solid CO<sub>2</sub>) before being driven. If the diameter of a hole is 4.500 mm, what should be the diameter of a rivet at 23&#x00B0;C if its diameter is equal to that of the hole when rivet is cooled to -78&#x00B0;C, the temperature of the dry ice? expansion coefficient for aluminium is 2.4 x 10<sup>-5</sup> &#x00B0;C<sup>-1</sup>.
