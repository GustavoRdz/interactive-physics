...
#TemperatureHeat.eg-theme-agrume
  .eg-slideshow
    ...
    slide(:steps=1, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      ...
      div.pcontainer   
        .center
          img(src='./assets/p16.png' width="100%" style="margin: 0px 0px 0px 0px;")      
      div.pcontainer   
        .center
          img(src='./assets/p17.png' width="100%" style="margin: 0px 0px 0px 0px;")      
      div.pcontainer   
        .center
          img(src='./assets/p18.png' width="100%" style="margin: 0px 0px 0px 0px;")      
      div.pcontainer   
        .center
          img(src='./assets/p19.png' width="100%" style="margin: 0px 0px 0px 0px;")      
      div.pcontainer   
        .center
          img(src='./assets/p20.png' width="100%" style="margin: 0px 0px 0px 0px;")      
      div.pcontainer   
        .center
          img(src='./assets/p21.png' width="100%" style="margin: 0px 0px 0px 0px;")   
