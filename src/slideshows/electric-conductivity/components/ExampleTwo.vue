<template lang="pug">
  eg-transition(:enter='enter', :leave='leave')
    .eg-slide-content
      p.problem A coaxial cable consists of two concentric cylindrical conductors. The region between the conductors is completely filled with polyethylene plastic. Current leakage through the plastic, in the radial direction, is unwanted. (The cable is designed to conduct current along its length, but that is not the current being considered here.) The radius of the inner conductor is a = 0.500 cm, the radius of the outer conductor is b = 1.75 cm, and the length is L = 15.0 cm. The resistivity of the plastic is 1.0&times;10<sup>13</sup> &Omega;m. Calculate the resistance of the plastic between the two conductors.
      .center
        img(src='../assets/fig27-8.png' style="height: 400px;")
