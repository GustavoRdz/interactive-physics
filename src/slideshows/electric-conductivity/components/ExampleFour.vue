...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Consider the circuit shown in figure. Find (a) the current in the 20.0-V resistor and (b) the potential difference between points a and b.
    .center
      img(src='../assets/figP28-9.png' width="300px")
    //- .center
