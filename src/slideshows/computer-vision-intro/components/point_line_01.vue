...
.eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
  p.problem 2D line: slope-ordinate representation
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 300" height="300" width="500" >
        <g style="text-transform: none;">
          ...
          <line  x1="0" y1="10" x2="5" y2="0" stroke="#000">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="55 10" begin="0s" dur="1s" fill="freeze"/>
          </line>
          <line  x1="0" y1="0" x2="5" y2="10" stroke="#000">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="60 10" begin="0s" dur="0.9s" fill="freeze"/>
          </line>
          ...
          <line  x1="0" y1="5" x2="10" y2="0" stroke="#000">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="280 240" begin="0s" dur="0.8s" fill="freeze"/>
          </line>
          <line  x1="0" y1="0" x2="10" y2="5" stroke="#000">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="280 235" begin="0s" dur="0.7s" fill="freeze"/>
          </line>
        
          <g>
            <text x="0" y="0" font-size="25" font-family= "Times" font-style="italic" fill="black">y</text>
            <animateTransform attributeName="transform" type="translate" from='0 0' to="30, 30" begin="0s" dur="2s" fill="freeze"/>
          </g>
          <g>
            <text x="0" y="0" font-size="25" font-family= "Times" font-style="italic" fill="black">x</text>
            <animateTransform attributeName="transform" type="translate" from='0 0' to="260 270" begin="0s" dur="2s" fill="freeze"/>
          </g>

          <line  x1="-300" y1="-150" x2="500" y2="-26" stroke-width="3" stroke="#0F0" opacity="0.8">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="244 256" begin="1s" dur="3s" fill="freeze"/>
          </line>
          <circle  cx="0" cy="0" r="3" fill="#F00">
            <animateTransform attributeName="transform" type="translate" from='500 0' to="160 140" begin="1s" dur="1s" fill="freeze"/>
          </circle>
          <line  x1="0" y1="0" x2="100" y2="0" stroke="#00F">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="60 140" begin="1s" dur="1s" fill="freeze"/>
          </line>
          <line  x1="0" y1="0" x2="0" y2="100" stroke="#00F">
            <animateTransform attributeName="transform" type="translate" from='0 0' to="160 140" begin="1s" dur="1s" fill="freeze"/>
          </line>
          <g>
            ...
            <animateTransform attributeName="transform" type="translate" from='0 0' to="165 130" begin="0s" dur="3s" fill="freeze"/>
          </g>
          <circle  cx="0" cy="0" r="3" fill="#F00">
          ...
          <g>
            <text x="0" y="0" font-size="20" font-family= "Times" font-style="italic" fill="#00F">m</text>
            <text x="20" y="0" font-size="20" font-family= "Times" fill="black">=</text>
            <text x="50" y="-15" font-size="20" font-family= "Times" fill="black">&Delta;</text>
            <text x="63" y="-15" font-size="20" font-family= "Times" font-style="italic" fill="black">y</text>
            <line  x1="40" y1="-5" x2="80" y2="-5" stroke="#000"/>
            <text x="50" y="15" font-size="20" font-family= "Times" fill="black">&Delta;</text>
            <text x="63" y="15" font-size="20" font-family= "Times" font-style="italic" fill="black">x</text>
            <animateTransform attributeName="transform" type="translate" from='0 0' to="320 140" begin="2s" dur="3s" fill="freeze"/>
          </g>
          <g>
