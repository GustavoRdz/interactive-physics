...
#OscillatoryMotion.eg-theme-agrume
  .eg-slideshow
    ...
    slide.boredYet(enter='bounceInDown' , :mouseNavigation='false' :keyboardNavigation='false')
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }} // Efecto Doppler</sup>
...
export default {
  ...
  infos: {
    ...
    description: 'Ejercicios sobre movimiento ondulatorio',
    path: 'exercises-waves'
  },
  components: {
