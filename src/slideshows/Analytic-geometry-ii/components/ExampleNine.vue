...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem una cuerda de la parábola 
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh>{{ A>0 ? " " : " -" }}{{ Math.abs(A)===1 ? "" : Math.abs(A) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=vh>x</span><span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      // <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh> + </span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>{{ C>0 ? " " : " - " }}{{ Math.abs(C)===1 ? "" : Math.abs(C) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=1-vh>y</span><span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      // <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>+</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>{{ D>0 ? " + " : " - " }}{{ Math.abs(D)===1 ? "" : Math.abs(D) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=1-vh>x</span>
      //<span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=D>+</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh>{{ E>0 ? " + " : " - " }}{{ Math.abs(E)===1 ? "" : Math.abs(E) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=vh>y</span>
      //<span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=E>+</span>
      //- <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=F>{{ F>0 ? " + " : " - " }}{{ Math.abs(F)===1 ? "" : Math.abs(F) }}</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;"> = 0</span>
      <span> es un segmento de la recta</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;">{{ F>0 ? " " : " -" }}{{ Math.abs(F)===1 ? "" : Math.abs(F) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;">x</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh>{{ D>0 ? " + " : " - " }}{{ Math.abs(D)===1 ? "" : Math.abs(D) }}</span><span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>{{ E>0 ? " +  " : " - " }}{{ Math.abs(E)===1 ? "" : Math.abs(E) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;">y</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;"> = 0</span>. Hallar su longitud
