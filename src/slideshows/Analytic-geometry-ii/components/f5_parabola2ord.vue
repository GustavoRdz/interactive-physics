  ...
  .eg-slide-content
    ...
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" height="300px" width="600px" >
        ...
        <!-- eje focal -->
        <line  x1="0" y1="150" x2="300" y2="150" stroke-linecap="round" fill="none" stroke="#0aF" stroke-width="1"/>
        
        <!-- plots -->
        <!-- directriz -->
        <line :x1="150 -deltaX*p" y1="0" :x2="150 - deltaX*p" y2="300" fill="none" stroke="#0aF" stroke-width="3" stroke-linecap="round"/>
        
        <!-- Lado recto -->
        <line :x1="150 + deltaX*p" :y1="150 - 2*deltaY*p" :x2="150 + deltaX*p" :y2="150 + 2*deltaY*p" fill="none" stroke="#F0a" stroke-width="1" stroke-linecap="round"/>
        <circle r="4" :cx="150 + deltaX*p" :cy="150 - 2*deltaY*p"  fill="#000" stroke="#F0a" stroke-width="2"/>
        <circle r="4" :cx="150 + deltaX*p" :cy="150 + 2*deltaY*p"  fill="#000" stroke="#F0a" stroke-width="2"/>
        ...
        <!-- extremos lado recto LR(h+p, k+-p) -->
        <text :x="60 + deltaX*p" y="50" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;"></tspan>(<tspan style="font-style: italic;">h+p</tspan>, <tspan style="font-style: italic;">k+2p</tspan>)</text>
        <text :x="60 + deltaX*p" y="270" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;"></tspan>(<tspan style="font-style: italic;">h+p</tspan>, <tspan style="font-style: italic;">k-2p</tspan>)</text>
        ...
        <!-- Segmento LP -->
        <line :x1="0" y1="0" :x2="150 - deltaX*p" :y2="0" fill="none" stroke="#777" stroke-width="2" stroke-linecap="round">
          <animate attributeName="x1" :values="parabolaX" dur="5" repeatCount="indefinite"/>
          <animate attributeName="y1" :values="parabolaY" dur="5" repeatCount="indefinite"/>
        ...
        <!-- Eje focal y = k -->
        <text x="0" y="145" font-size="15" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: normal;">Eje focal: </tspan></text>
        <text x="5" y="165" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;">y</tspan><tspan style="font-style: normal;"> = </tspan><tspan style="font-style: italic;">k</tspan></text>

        <!-- texto f(p, 0) -->
        <text :x="160 + deltaX*p" y="140" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;">f</tspan>(<tspan style="font-style: italic;">h</tspan><tspan style="font-style: normal;">+|</tspan><tspan style="font-style: italic;">p</tspan><tspan style="font-style: normal;">|</tspan>, <tspan style="font-style: italic;">k</tspan>)</text>
        ...
        <!-- texto L(-p,y) -->
        <text :x="65-deltaX*p" y="0" font-size="20" fill="#00F" font-weight="bold" font-family="Times" style="font-style: italic;"><tspan style="font-style: italic;">L</tspan>(<tspan style="font-style: italic;">h</tspan><tspan style="font-style: normal;">-|</tspan><tspan style="font-style: italic;">p</tspan><tspan style="font-style: normal;">|</tspan>, <tspan style="font-style: italic;">k</tspan>)
          <animate attributeName="y" :values="parabolaY" dur="5" repeatCount="indefinite"/>
        </text>
        ...
        <!-- texto Lado recto -->
        <text x="190" y="80" font-size="15" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: normal;">Lado recto</tspan></text>

         <!-- ecuacion parabola -->
         <text x="200" y="230" font-size="35" fill="#F00" font-weight="bold" font-family="Times">(<tspan style="font-size: 30px; font-style: italic;">y - k</tspan>)<tspan style="font-size: 15px;" baseline-shift = "super">2</tspan>&ensp;= 4<tspan style="font-size: 30px; font-style: italic;">p</tspan>(<tspan style="font-size: 30px; font-style: italic;">x - h</tspan>)</text>
