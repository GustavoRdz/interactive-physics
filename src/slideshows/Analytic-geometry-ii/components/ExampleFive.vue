...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Reducir la ecuación 
      ...
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=D>{{ D>0 ? " + " : " - " }}{{ Math.abs(D)===1 ? "" : Math.abs(D) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=D>x</span>
      //<span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=D>+</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=E>{{ E>0 ? " + " : " - " }}{{ Math.abs(E)===1 ? "" : Math.abs(E) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=E>y</span>
      ...
      <span>a la segunda forma ordinaria y determinar, si es posible: las coordenadas del vértice, las coordenadas del foco, la ecuación de la directriz, la longitud del lado recto y trazar su lugar geométrico.</span>  
