...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Hallar la ecuación de la parábola de vértice en el origen y uno de los extremos del lado recto es el punto 
      <span style="font-family: roboto; font-weight: bold; font-style: italic;">P</span><span style="font-family: roboto; font-weight: bold; font-style: normal;">({{ D }}, {{ E }})</span>
