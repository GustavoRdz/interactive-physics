...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Determine qué lugar geométrico representa la ecuación dada, trace su grafica. 
...
export default {
  ...
  computed: {
    ...
    a: function () {
      return this.vh === 0 ? this.mayor : this.menor
    },
    b: function () {
      return this.vh === 0 ? this.menor : this.mayor
    },
    A: function () {
      return this.b ** 2
    },
    ...
    D: function () {
      return -2 * this.h * this.b ** 2
    },
    E: function () {
      return -2 * this.k * this.a ** 2
    },
    F: function () {
      return (this.h * this.b) ** 2 + (this.a * this.k) ** 2 - (this.a * this.b) ** 2
    },
    bx: function () {
      let max = 5
      let min = -5
