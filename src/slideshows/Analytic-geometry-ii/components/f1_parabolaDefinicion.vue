  ...
  .eg-slide-content
    ...
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" height="300px" width="600px" >
        ...
        <!-- texto f(p, 0) -->
        <text :x="170 + deltaX*p" y="140" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;">f</tspan>(<tspan style="font-style: italic;">p</tspan>,0)</text>
        <!-- texto p(x,y) -->
        ...
        <!-- texto L(-p,y) -->
        <text :x="160-deltaX*p" y="0" font-size="20" fill="#00F" font-weight="bold" font-family="Times" style="font-style: italic;">L(<tspan style="font-style: italic;">-p</tspan>,y)
          <animate attributeName="y" :values="parabolaY" dur="5" repeatCount="indefinite"/>
        </text>
