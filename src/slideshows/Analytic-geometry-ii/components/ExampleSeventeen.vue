...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Los vértices de la elipse son <span style="font-family: roboto; font-weight: bold; font-style: italic;">V</span><span style="font-family: roboto; font-weight: bold; font-style: normal;">({{ V1x }}, {{ V1y }})</span>, <span style="font-family: roboto; font-weight: bold; font-style: italic;">V</span><span style="font-family: roboto; font-weight: bold; font-style: normal;">({{ V2x }}, {{ V2y }})</span> y la longitud del lado recto es <span style="font-family: roboto; font-weight: bold; font-style: normal;">{{ lr }}</span>. Hallar la ecuación de la elipse y sus elementos. 
