  ...
  .eg-slide-content
    ...
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" height="300px" width="600px" >
        ...
        <!-- plots -->
        <!-- directriz -->
        <line x1="0" :y1="150 + deltaY*p" x2="300" :y2="150 + deltaY*p" fill="none" stroke="#555" stroke-width="3" stroke-linecap="round"/>
        ...
        <!-- texto f(p, 0) -->
        <text x="160" :y="140 - deltaY*p" font-size="20" fill="#00F" font-weight="bold" font-family="Times"><tspan style="font-style: italic;">f</tspan>(0, <tspan style="font-style: italic;">p</tspan>)</text>
        <!-- texto p(x,y) -->
        ...
        <!-- texto L(-p,y) -->
        <text x="170-deltaX*p" :y="150 + deltaY*p" font-size="20" fill="#00F" font-weight="bold" font-family="Times" style="font-style: italic;">L(x, <tspan style="font-style: italic;">-p</tspan>)
          <animate attributeName="x" :values="parabolaX" dur="5" repeatCount="indefinite"/>
        </text>
