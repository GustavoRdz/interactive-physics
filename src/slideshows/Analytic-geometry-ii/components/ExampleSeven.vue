...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Hallar la ecuación de la parábola, las coordenadas del foco y la longitud del lado recto, si su vértice está en el origen y la ecuación de la directriz es la recta 
      <span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=vh>x</span>
      <span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=1-vh>y</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=F>{{ F>0 ? " + " : " - " }}{{ Math.abs(F) }}</span>
