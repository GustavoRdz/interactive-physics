...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Encuentre la ecuación de la elipse con centro en el origen y foco en  
      <span style="font-family: roboto; font-weight: bold; font-style: italic;">f</span><span style="font-family: roboto; font-weight: bold; font-style: normal;">({{ fx }}, {{ fy }})</span> y vértice en  <span style="font-family: roboto; font-weight: bold; font-style: italic;">V</span><span style="font-family: roboto; font-weight: bold; font-style: normal;">({{ Vx }}, {{ Vy }})</span>
