  ...
  .eg-slideshow
    slide(enter='fadeIn' leave='bounceOutLeft' :mouseNavigation='false')
      .center.frontpage
        ...
        h4 Machine Vision<br>Visual Sensing and Image Processing
    ...
    slide(:steps=1, enter='bounceInRight' leave='bounceOutDown' :mouseNavigation='false')
      ...
      .center
        ...
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Imaging Devices</b><br><span style="font-size: 0.7em;">Image Display: Interlacing</span>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Image Processing</b>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Image Representation</b><br><span style="font-size: 0.7em;">Binary Image, Gray Scale Image, Histogram, Histogram Modification.</span>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Image Filtering</b><br><span style="font-size: 0.7em;">Mean Filter, Median Filter.</span>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Image Segmentation</b><br><span style="font-size: 0.7em;">Thresholding, Iterative Thresholding, Region-Based Segmentation</span>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Edge Detection</b><br><span style="font-size: 0.7em;">Roberts Operator, Sobel Operator. Laplacian Operator.</span>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Hough Transform</b>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1" style="margin: -10px 0 0 0;")
            <b>Camera Calibration</b><br><span style="font-size: 0.7em;">Perspective Projection</span>

    slide(:steps=1, enter='bounceInDown' :mouseNavigation='false')
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  :  {{ theme }}</sup>
      h4(style="margin: -20px 0 0 0; ").center Visual sensing
      p(style="padding: 15px; margin: 1px; line-height: 1.5em;") Visual sensing is prerequisite for understanding the structure of a 3D environment, which requires assessing the shape and position of objects.
      p(style="padding: 15px; margin: 1px; line-height: 1.5em;") The sensing is to acquire the image of the environment through a visual or an imaging system, usually a camera system.
      ...
      p(style="padding: 15px; margin: 1px; line-height: 1.5em;") In proportion to the intensity of the received light, the imaging hardware device process and digitize in a discrete fashion so that a computer can understand the digitized values. 
      p(style="padding: 15px; margin: 1px; line-height: 1.5em;") After digitization, this signal is sent to a computer for image processing.

    slide(:steps=1, enter='bounceInDown' :mouseNavigation='false')
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  :  {{ theme }}</sup>
      h5(style="margin: -20px 0 0 0; ").center Image processing, analyzing, and understanding
      p(style="padding: 15px; margin: 1px; line-height: 1.5em;") (1) Preprocessing (2) Intermediate processing (3) Feature extraction (4) Scene understanding.
      .center
        img(src='./assets/fig3-1.png' height="500px")

    slide(:steps=1, enter='bounceInDown' :mouseNavigation='false')
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  :  {{ theme }}</sup>
      h6(style="margin: 0px 0 40px 0; ").center Features
      .center
        img(src='./assets/table3-1.png' height="700px")
