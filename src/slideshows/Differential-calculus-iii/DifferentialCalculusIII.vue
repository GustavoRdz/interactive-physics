  ...
  .eg-slideshow
    ...
    slide(enter='fadeIn' leave='bounceOutLeft' :mouseNavigation='false' style="overflow: scroll;")
      ...
      .center.frontpage
        ...
        h2(v-if = 'isSpanish' style="margin: 0px 0px 0px 0px;") Differential calculus
        ...
        h4(v-if = 'isSpanish' style="margin: 0px 0px 30px 0px;") Derivada parcial, differencial total, regla de la cadena
    ...
    slide(:steps=1, enter='bounceInRight' leave='bounceOutDown' :mouseNavigation='false' style="overflow: scroll;")
      ...
      .center
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1")
            <b>Segmento rectilíneo dirigido</b>
        eg-transition(enter='bounceInRight' leave='bounceOutRight')
          p(v-if="step >= 1")
            <b>Sistema coordenado unidimensional, bidimensional</b>
        eg-transition(enter='bounceInLeft' leave='bounceOutLeft')
          p(v-if="step >= 1")
...
export default {
  ...
  infos: {
    title: 'Derivada parcial, diferencia total, regla de la cadena ',
    description: 'Partial derivatives, total differential, chain rule',
    path: 'DifferentialCalculusIII',
  ...
  data: function () {
    return {
      ...
      topics: ['Inicio', 'Temas', 'Funciones de varias variables', 'Limites', 'Continuidad', 'Derivada parciales', 'Diferencial total', 'regla de la cadena', 'Bibliografía'],
