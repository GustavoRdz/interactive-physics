<template lang="pug">
#QuantumComputing.eg-theme-agrume
  .eg-slideshow
    ...
    slide(enter='fadeIn' leave='bounceOutLeft' :mouseNavigation='false' style="overflow: scroll;")
      ...
      .center.frontpage
        h2(v-if = '!isSpanish' style="margin: 0px 0px 0px 0px;") Quantum computer science
        h2(v-if = 'isSpanish' style="margin: 0px 0px 0px 0px;") Ciencia de la computación cuántica
        ...
        h4(v-if = '!isSpanish' style="margin: 0px 0px 30px 0px;") Quantum computing
        h4(v-if = 'isSpanish' style="margin: 0px 0px 30px 0px;") Computación cuántica
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h3(style="margin-top: -20px;") Classical states
      p.center What is a classical state
      .center
    ...
    slide(:steps=1, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      ...
      div.pcontainer      
        .center
          img(src='./assets/t1.png' width="100%" style="margin: -10px 0px -20px 0px;")
