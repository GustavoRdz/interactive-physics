  ...
  .eg-slideshow
    ...
    slide(enter='fadeIn' leave='bounceOutLeft' :mouseNavigation='false' style="overflow: scroll;")
      ...
      .center.frontpage
        ...
        h2(v-if = 'isSpanish' style="margin: 0px 0px 0px 0px;") Calculo diferencial
        ...
        h4(v-if = 'isSpanish' style="margin: 0px 0px 30px 0px;") Derivadas, razon de cambio y optimización 
...
export default {
  ...
  infos: {
    title: 'Derivada, razón de cambio y optimización',
    description: 'Derivatives, change ratio and optimization',
    path: 'DifferentialCalculusII',
  ...
  data: function () {
    return {
      ...
      topics: ['Inicio', 'Temas', 'Derivacion implicita', 'Logaritmica', 'De orden superior', 'Razon de cambio', 'Criterio de primera y segunda deivada', 'Optimización', 'Bibliografía'],
