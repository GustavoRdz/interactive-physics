...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Trazar la curva cuya ecuación es 
   
    p.center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 150" height="150px" width="300px" >
        <g transform="translate(0, 0)">    
          <text x="5" y="50" font-size="30" fill="black" font-weight="bold" font-family="Times">
            <tspan style="font-style: italic;">r</tspan>
            <tspan style="font-style: normal;"> = </tspan>
          </text>
          <line fill="none" stroke="black" stroke-width="2" x1="50" y1="42" x2="200" y2="42" stroke-linecap="round"/>
          <text x="105" y="30" font-size="30" fill="black" font-weight="bold" font-family="Times">
            <tspan style="font-style: normal;">3</tspan>
          </text>
          <text x="60" y="75" font-size="30" fill="black" font-weight="bold" font-family="Times">
            <tspan style="font-style: italic;">&Sqrt;</tspan>
            <tspan style="font-style: normal;">cos2</tspan><tspan style="font-style: italic;">&theta;</tspan>
          </text>
          <line fill="none" stroke="black" stroke-width="1" x1="80" y1="48" x2="170" y2="48" stroke-linecap="round"/>
        </g>
      </svg>
    ...
    //-   </svg>
    //- p abc = {{ abc }},  vh= {{ vh }}, a={{ a }}, b={{ b }}, c= {{ c }}, h= {{ h }}, k={{ k }} fx = {{ h + (1-vh)*Math.sqrt(mayor**2 - menor**2) }}, fy = {{ k + vh*Math.sqrt(mayor**2 - menor**2) }}
...
export default {
  ...
  computed: {
    ...
    A: function () {
      return this.vh === 0 ? this.b ** 2 : -1 * this.a ** 2
    },
    C: function () {
      return this.vh === 0 ? -1 * this.a ** 2 : this.b ** 2
    },
    D: function () {
      return this.vh === 0 ? -2 * this.h * this.b ** 2 : 2 * this.h * this.a ** 2
    },
    E: function () {
      return this.vh === 0 ? 2 * this.k * this.a ** 2 : -2 * this.k * this.b ** 2
    },
    F: function () {
      return this.vh === 0 ? this.b ** 2 * this.h ** 2 - this.a ** 2 * this.k ** 2 - this.a ** 2 * this.b ** 2 : -1 * this.a ** 2 * this.h ** 2 + this.b ** 2 * this.k ** 2 - this.a ** 2 * this.b ** 2
    },
    bx: function () {
      let max = 5
      let min = -5
