...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Encontrar la ecuación de la hipérbola que pasa por el punto <span style="font-family: roboto; font-weight: bold; font-style: italic;">P</span><span style="font-family: roboto; font-weight: bold; font-style: normal;"v-if=vh>(0, {{ c }})</span> su centro se encuentra en el origen, y su eje focal se encuentra sobre el eje <span style="font-family: roboto; font-weight: bold; font-style: italic;">X</span>, y una de sus asisntotas es la recta  
    p.problem.center
      <span style="font-family: roboto; font-weight: bold; font-style: normal;">{{ b>0 ? " " : " -" }}{{ Math.abs(b)===1 ? "" : Math.abs(b) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;">x</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" >{{ a>0 ? " - " : " - " }}{{ Math.abs(a)===1 ? "" : Math.abs(a) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;">y</span>
