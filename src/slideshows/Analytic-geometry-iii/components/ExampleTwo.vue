...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Encontrar las ecuaciones de las asíntotas de la hipérbola
    p.problem.center
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh>{{ b>0 ? " " : " -" }}{{ Math.abs(b)===1 ? "" : Math.abs(b) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;" v-if=vh>x</span><span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=vh><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" >{{ a>0 ? " - " : " - " }}{{ Math.abs(a)===1 ? "" : Math.abs(a) }}</span><span style="font-family: roboto; font-weight: bold; font-style: italic;">y</span><span style="font-family: roboto; font-weight: bold; font-style: normal;"><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      ...
      <span style="font-family: roboto; font-weight: bold; font-style: normal;"> = {{ a*b }}</span>     
...
export default {
  ...
  computed: {
    ...
    V1x: function () {
      ...
      sg = sg === 0 ? -1 : 1
      return sg * Math.round(Math.random() * (max - min + 1) + min)
    },
    V1y: function () {
      let max = 10
      let min = 3
    ...
    V2x: function () {
      ...
      sg = sg === 0 ? -1 : 1
      let ret
      ret = this.vh ? this.V1x : sg * Math.round(Math.random() * (max - min + 1) + min)
      return ret
    },
    V2y: function () {
      let max = 10
      ...
      sg = sg === 0 ? -1 : 1
      let ret
      ret = this.vh ? sg * Math.round(Math.random() * (max - min + 1) + min) : this.V1y
      return ret
    },
    lr: function () {
      let max = 7
