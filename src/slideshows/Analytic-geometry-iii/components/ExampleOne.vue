...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Los focos de una hipérbola son 
      <span style="font-family: roboto; font-weight: bold; font-style: italic;">f</span><span style="font-family: roboto; font-weight: bold; font-style: normal;"v-if=vh>(0, {{ c }})</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>({{ c }}, 0)</span> y
      <span style="font-family: roboto; font-weight: bold; font-style: italic;">f</span><span style="font-family: roboto; font-weight: bold; font-style: normal;"v-if=vh>(0, -{{ c }})</span>
      <span style="font-family: roboto; font-weight: bold; font-style: normal;" v-if=1-vh>(-{{ c }}, 0)</span> y su excentricidad, <span style="font-family: roboto; font-weight: bold; font-style: italic;">e</span><span style="font-family: roboto; font-weight: bold; font-style: normal;"> = {{ c }}/{{ a }}</span>. Encontrar la ecuación de la hipérbola, las coordenadas de sus vertices, las longitudes de sus ejes tranverso y conjugado, y la longitud de cada lado recto, trazar su gráfica. 
