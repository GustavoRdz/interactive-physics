...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Discuta el lugar geométrico que representa la ecuación dada, trace su grafica. 
   
    p.center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 50" height="50px" width="1000px" >
