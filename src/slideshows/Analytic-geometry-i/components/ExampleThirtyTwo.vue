...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem Encuentre la ecuación de la circunferencia con centro en C({{ H }}, {{ K }}) y es tangente al eje  <span style="font-family: roboto; font-weight: bold; font-style: italic;">x</span>.
    .center
    ...
    //- p {{ R }},m {{ r }}, {{ x0y1 }}, xy {{ x0y2 }}   XY  {{ X0Y1 }}, xy {{ X0Y2 }}
    .center
