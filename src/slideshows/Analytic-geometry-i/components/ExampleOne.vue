...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    ...
    p(v-if = 'language' style="margin: 25px 0px 0px 0px;").problem Demostrar que los puntos ({{ x1i }}, {{ y1i }}),({{ x2i }}, {{ y2i }}) y ({{ x3i }}, {{ y3i }}) son los vertices de un triangulo isoceles
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 500" height="500px" width="700px" >
        ...
        <text :x="x1" :y="y1" font-size="20" fill="black" font-weight="bold" font-family="Times" font-style="italic"> P1 </text>
        <circle r="6" :cx="x2" :cy="y2"  fill="blue" stroke="#000" stroke-width="1"/>
        <text :x="x2" :y="y2" font-size="20" fill="black" font-weight="bold" font-family="Times" font-style="italic"> P2 </text>
        <circle r="6" :cx="x3" :cy="y3"  fill="green" stroke="#000" stroke-width="1"/>
        <text :x="x3" :y="y3" font-size="20" fill="black" font-weight="bold" font-family="Times" font-style="italic"> P3 </text>
...
export default {
  ...
  computed: {
    ...
    d12: function () {
      console.log(this.x1i)
      console.log(this.x2i)
      console.log(this.y1i)
      console.log(this.y2i)
