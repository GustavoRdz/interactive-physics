    ...
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 50 300 450" height="600" width="600" >
        ...
        <g transform="translate(0,80) ">
          ...
          <path d="M0,100 L60,100 40,90 M60,100 L40,110"  stroke="red" fill="none" stroke-width="3" opacity="1"/>
          <path d="M260,80 L350,80 340,75 M350,80 L340,85"  stroke="black" fill="none" stroke-width="3" opacity="1"/>
          <text x="260" y="70" font-size="15px" fill="black" stroke-width="2">Movimiento del átomo</text>
