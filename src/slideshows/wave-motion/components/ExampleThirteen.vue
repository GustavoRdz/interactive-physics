...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem A wire with mass 40.0 g is stretched so that its ends are tied down at points 80.0 cm apart. The wire vibrates in its fundamental mode with frequency 60.0 Hz and with an amplitude at the antinodes of 0.300 cm. (a) What is the speed of propagation of transverse waves in the wire? (b) Compute the tension in the wire. (c) Find the maximum transverse velocity and acceleration of particles in the wire.
