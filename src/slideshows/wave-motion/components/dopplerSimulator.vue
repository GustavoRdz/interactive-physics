...
.eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" height="300" width="800" version="1.1" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" viewBox="0 0 1000 300">
        ...
        <circle :cx="x[index]" cy="150" r="5" fill="white" stroke="gray" stroke-width="5" opacity="1" v-for="(item, index) in x"/>
        ...
        <circle cx="200" cy="125" r="5" fill="white" stroke="black" stroke-width="5" opacity="1"/>
        <circle cx="800" cy="125" r="5" fill="white" stroke="black" stroke-width="5" opacity="1"/>
    ...
    div.time-control
      div(style="display: flex; justify-content: space-around; border: solid 1px; border-radius: 10px; height: 80px;")
        div
          p(style="font-family: Times; font-style: italic; font-size:20px; font-weight: bold;color: black; margin: auto;").center fr = <span style="font-style: normal;">{{ frAtras.toPrecision(3) }} ff</span><br>
          p(style="font-family: Times; font-style: italic; font-size:20px; font-weight: bold;color: black; margin: auto;").center fr= <span style="font-style: normal;">{{ frDelante.toPrecision(3) }} ff</span><br>
        div
