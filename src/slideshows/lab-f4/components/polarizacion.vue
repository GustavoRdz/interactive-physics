    ...
    div(style="display: flex; flex-direction: row; justify-content: space-around;")
      div(style="display: flex; flex-direction: row; justify-content: space-around;")
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 500" height="500" width="1000" >
          ...
          <line x1="150" y1="100" x2="850" y2="150" stroke="#000000" opacity="0.1" stroke-width="1"/>  // x axis
          <line x1="150" y1="100" x2="270" y2="109" stroke="#000000" opacity="0.9"/>  // x axis visible section 1
          <line x1="300" y1="111" x2="570" y2="130" stroke="#000000" opacity="0.9"/>  // x axis visible section 2
          <line x1="600" y1="132" x2="850" y2="150" stroke="#000000" opacity="0.9"/>  // x axis visible section 3
          <ellipse cx="300" cy="110" rx="30" ry="60" fill="black" fill-opacity="0.3" stroke="#000000"  stroke-width="0.1"/>  // left polarizer
          <ellipse cx="600" cy="132" rx="30" ry="60" fill="black" fill-opacity="0.3" stroke="#000000"  stroke-width="0.1"/>  // right polarizer
          <line x1="300" y1="25" x2="300" y2="170" stroke="#000000" opacity="0.9"/>  // left polarizer transmission axis
          <line :x1="600 + 40 * Math.sin(angle * Math.PI / 180)* (1 - 0.1*Math.sin(angle * Math.PI / 180))" :y1="132 - 70*Math.cos(angle * Math.PI / 180)* (1 + 0.1*Math.cos(angle * Math.PI / 180))" :x2="600 - 40 * Math.sin(angle * Math.PI / 180)" :y2="132 + 70*Math.cos(angle * Math.PI / 180)" stroke="#000000" opacity="0.9"/>  // right polarizer transmission axis

          <path d="M150,50 L850,100 850,200 150,150" stroke="black"  fill="none" stroke-width="0.9" opacity="0.1"/>
          <ellipse cx="150" cy="100" rx="24" ry="50" fill="green" opacity="0.1" stroke="green"  stroke-width="0.1"/>
          <path d="M150,50 L282,60 A 30 60 0 0 0 282 160 L150,150  A 24 50 0 0 1 150 50 Z" stroke="green"  fill="green" opacity="0.9"/>
          <ellipse cx="300" cy="110" rx="24" ry="50" fill="green" opacity="0.1" stroke="green"  stroke-width="0.1"/>
          <path d="M300,60 L584,80 A 30 60 0 0 0 582 180 L300,160  A 24 50 0 0 1 300 60 Z" stroke="green"  fill="green" opacity="0.5"/>
          <ellipse cx="600" cy="132" rx="24" ry="50" fill="green" opacity="0.1" stroke="green"  stroke-width="0.1"/>
          <path d="M600,83 L850,100 A 24 50 0 0 0 850 200 L600,183  A 24 50 0 0 1 600 83 Z" stroke="green"  fill="green" :opacity="0.5*Math.cos(angle*Math.PI/180)**2"/>
          <ellipse cx="850" cy="150" rx="24" ry="50" fill="green" :opacity="0.5*Math.cos(angle*Math.PI/180)**2" stroke="green" stroke-width="0.1"/>
      ...
      div(style="display: flex; justify-content: space-around; border: solid 1px; border-radius: 10px; height: 130px; width: 90%; margin: auto")
        ...
        div
          p(style="font-family: Times; font-style: italic; font-size:20px; font-weight: bold;color: black;").center θ = <span style="font-style: normal;">{{ angle }} </span><br>
            button(@click="angle -=0.1;").time-btn -0.1
            button(@click="angle +=0.1;").time-btn +0.1
            <br>
            button(@click="angle -=1.0;").time-btn -1.0
            button(@click="angle +=1.0;").time-btn +1.0
            <br>
            button(@click="angle -=10;").time-btn -10.0
            button(@click="angle +=10;").time-btn +10.0
        div
          p(style="font-family: Times; font-style: italic; font-size:20px; font-weight: bold;color: black;").center θ = <span style="font-style: normal;">{{ angle }} </span><br>
