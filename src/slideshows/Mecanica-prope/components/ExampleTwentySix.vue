...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem En el triángulo formado por los puntos A({{ X1 }}, {{Y1}}), B({{ X2 }}, {{Y2}}) y C({{ X3 }}, {{Y3}}) encontrar las ecuaciones de las mediatrices de cada lado y demostrar que son concurrentes en un punto, llamado circuncentro. 
    .center
