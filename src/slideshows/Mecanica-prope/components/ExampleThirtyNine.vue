...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem El centro de la circunferencia esta sobre la recta
    ...
    p.problem Si la circunferencia pasa por los puntos P({{ X1 }}, {{ Y1 }}) y Q({{ X2 }}, {{ Y2 }}). encuentre su ecuación
    p(style="margin: 15px 0 10px 0; ").center
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: italic;">x</span>
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: normal;"><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: normal;"> + </span>
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: italic;">y</span>
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: normal;"><sup style="font-size: 20px; font-style: normal;">2</sup></span>
      <span v-if="showC" style="font-family: roboto; font-weight: bold; font-style: normal;">{{ Cc>0 ? " + " : " - " }}{{ Cc===""  ? " 0 " : Math.abs(Cc) }}</span>
      <span v-if="showC" style="font-family: roboto; font-weight: bold; font-style: italic;">x</span>
      <span v-if="showD" style="font-family: roboto; font-weight: bold; font-style: normal;">{{ D>0 ? " + " : " - " }}{{ D===""  ? " 0 " : Math.abs(D) }}</span>
      <span v-if="showD" style="font-family: roboto; font-weight: bold; font-style: italic;">y</span>
      <span v-if="showE" style="font-family: roboto; font-weight: bold; font-style: normal;">{{ E>0 ? " + " : " - " }}{{ E===""  ? " 0 " : Math.abs(E) }}</span>
      <span v-if="showC || showD || showE" style="font-family: roboto; font-weight: bold; font-style: normal;"> = 0</span>
    .center
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" height="300px" width="600px" >
        ...
        <circle v-if="showC && showD && showE" :r="r" :cx="h" :cy="k"  fill="none" stroke="#0F0" stroke-width="4"/>
        <circle v-if="showC && showD && showE" :r="3" :cx="h" :cy="k"  fill="#0F0" stroke="#0F0" stroke-width="4"/>
        <circle v-if="showC && showD && showE" :r="1" :cx="h" :cy="k"  fill="#000" stroke="#000" stroke-width="4"/>
        ...
        <!-- two points -->
        <circle v-if="showX1 && showY1" r="4" :cx="x1" :cy="y1"  fill="#0F0" stroke="#FF0" stroke-width="1"/>
        <circle v-if="showX2 && showY2" r="4" :cx="x2" :cy="y2"  fill="#0F0" stroke="#FF0" stroke-width="1"/>
    ...
    //- p.center H={{ H }}, K={{ K }}, R={{ R }}<br>X1={{ X1 }},Y1={{ Y1 }} <br>Xi2={{ Xi2 }},Yi2={{ Yi2 }} <br> show {{ showCircleXi2 }}, {{ showCircleYi2 }}  
    .center
...
export default {
  ...
  computed: {
    ...
    C: function () {
      return this.mb * this.K - this.ma * this.H
    },
    X1: function () {
    ...
    x1: function () {
      return 150 + this.delta * this.enterX1
    },
    Y1: function () {
      return Math.round(100 * (this.K - Math.sqrt(this.R ** 2 - (this.X1 - this.H) ** 2))) / 100
    },
    y1: function () {
      return 150 - this.delta * this.enterY1
    },
    X2: function () {
      let max = this.H
