...
#OscillatoryMotion.eg-theme-agrume
  .eg-slideshow
    ...
    slide(enter='fadeIn' leave='bounceOutLeft' :mouseNavigation='false' style="overflow: scroll;")
      ...
      .center.frontpage
        h2(v-if = '!isSpanish' style="margin: 0px 0px 0px 0px;") 
        h2(v-if = 'isSpanish' style="margin: 0px 0px 0px 0px;") Mecánica
        ...
        h4(v-if = '!isSpanish' style="margin: 0px 0px 30px 0px;") Sistemas de unidades, Trigonomertría y cinemática
        h4(v-if = 'isSpanish' style="margin: 0px 0px 30px 0px;") Sistemas de unidades, Trigonomertría y cinemática 
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Sistema de unidades
      p(style="margin-top: -40px; color: blue;") Con objeto de garantizar la uniformidad y equivalencia en las mediciones, así como facilitar las actividades tecnológicas industriales y comerciales, diversas naciones del mundo suscribieron el Tratado del Metro, en el que se adoptó el Sistema Métrico Decimal. 
      p(style="margin-top: -20px; color: blue;") Este Tratado fue firmado por diecisiete países en París, Francia, en 1875. 
      p(style="margin-top: -20px; color: blue;") México se adhirió al Tratado el 30 de diciembre de 1890. 
      p(style="margin-top: 0px; color: blue;") Las unidades de medida de uso obligatorio en México están establecidas en la Norma Oficial Mexicana NOM-008-SE-2021, Sistema general de unidades de medida (cancela a la NOM-008-SCFI-2002 [publicada en el DOF el 29 de diciembre de 2023]. 
      p(style="margin-top: 0px; color: blue;") Una descripción de dichas unidades, sus símbolos y sus reglas de escritura se encuentran en la publicación del CENAM Sistema Internacional de Unidades.
      //- .center
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Unidades fundamentales
      table(style=" font-size: 15px;") 
        ...
        tr
         ...
         td metro
         td m 
         td Es la longitud de la trayectoria recorrida por la luz en el vacío durante 1/299 792 458 de segundo
        tr
         td Masa 
         td kilogramo 
         td kg 
         td Unidad básica de masa, definida a partir de un prototipo de kilogramo compuesto por una aleación de 90% platino y 10% iridio, de forma cilindrica, de 39 mm de altura, 39 mm de diametro y una densidad de 21500 kg/m<sup>3</sup>
         
        tr
         td Tiempo 
         td segundo 
         td s 
         td Es la duración de 9 192 631 770 periodos de la radiación correspondientes a la transición entre dos niveles hiperfinnos del átomo de cesio 133.
         
        tr
         td Corriente eléctrica 
         td Ampere 
         td A 
         td ES la intensidad de corriente constante, que mantenida en dos conductores paralelos rectilíneos de longitud infinita, cuya sección circular es despreciable, colocados a un metro de distancia entre sí, en el vacío, producirá entre los dos conductores una fuerza igual a 2x10<sup>-7</sup> newton por cada metro de longitud.
         
        tr
         td Temperatura termodinámica 
         td Kelvin 
         td Kelvin. 
         td Es la fracción 1/273,16 de la temperatura termodinámica del punto triple del agua
          
        tr
         td Cantidad de sustancia 
         td Mol
         td mol 
         td Es la cantidad de sustancia que contiene tantas entidades elementales como existen átomos en 0,012 kg de carbono 12          
        tr
         td Intensidad luminosa 
         td Candela 
         td cd 
         td Es la intensidad luminosa en una dirección dada de una fuente que emite una radiación monocromática de frecuencia 540x10<sup>12</sup> Hertz y cuya intensidad energética en esa dirección es 1/683 watt por esterrradián
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Unidades derivadas
      p(style="margin-top: -40px; color: blue;") Las unidades derivadas son el resultado de expresiones algebraicas que relacionan las magnitudes de acuerdo con las leyes de la física, combinando congruentemente las unidades fundamentales entre sí, o bien, combinando a éstas con las suplementarias. 
      ...
      table(style=" font-size: 15px;") 
        tr
          ...
          th Nombre (SI)
          th Símbolo
          th En otras unidades
          th Analisis dimensional
        tr
         td Fuerza
         td Newton
         td N 
         ...
         td kg·m/s<sup>2</sup>
        tr
         td Trabajo, energía, cantidad de calor 
         td Joule
         td J 
         td N·m
         td (kg·m/s<sup>2</sup>)(m) <br> kg·m<sup>2</sup>/s<sup>2</sup>
         
        tr
         td Potencia, flujo energético 
         td Watt 
         td W 
         td N·m/s
         td (kg·m/s<sup>2</sup>)(m)/s <br> kg·m<sup>2</sup>/s<sup>3</sup>
        ...
        tr
         ...
         td Pa 
         td N/m<sup>2</sup>
         td (kg·m/s<sup>2</sup>)/(m<sup>2</sup>) <br> kg/(m·s<sup>2</sup>) 
          
        tr
         td Temperatura Celsius 
         td grado celsius
         td ºC 
         td 
         td K
        ...
        tr
         td Carga electrica, cantidad de electricidad 
         td Coulomb
         td C
         td 
         td A·s
        ...
        tr
         td Diferencia de potencial, voltaje, tensón eléctrica, fuerza electromitriz, potencial eléctrico 
         td Volt 
         td V
         td W/A
         td [(kg·m/s<sup>2</sup>)(m)/s]/A <br> [(kg·m<sup>2</sup>/s<sup>3</sup>)]/A <br>(kg·m<sup>2</sup>)/(A·s<sup>3</sup>)
        tr
         td Capacitancia eléctrica
         td Farad 
         td F
         td C/V
         td (A·s)/[(kg·m<sup>2</sup>)/(A·s<sup>3</sup>)] <br> (A<sup>2</sup>·s<sup>4</sup>)/(kg·m<sup>2</sup>)

        tr
         td Resistencia eléctrica
         td Ohm 
         td &Omega;
         td V/A
         td [(kg·m<sup>2</sup>)/(A·s<sup>3</sup>)]/A <br> (kg·m<sup>2</sup>)/(A<sup>2</sup>·s<sup>3</sup>) 

        tr
         td Conductancia eléctrica 
         td Siemens 
         td S
         td A/V
         td A/[(kg·m<sup>2</sup>)/(A·s<sup>3</sup>)] <br> (A<sup>2</sup>·s<sup>3</sup>)/(kg·m<sup>2</sup>)
        ...
        tr
         ...
         td Wb
         td V·s
         td [(kg·m<sup>2</sup>)/(A·s<sup>3</sup>)]·s <br> (kg·m<sup>2</sup>)/(A·s<sup>2</sup>)

        tr
         td Inducción magnética 
         td Tesla
         td T
         td Wb/m<sup>2</sup>
         td [(kg·m<sup>2</sup>)/(A·s<sup>2</sup>)]/m<sup>2</sup> <br> (kg)/(A·s<sup>2</sup>)
        ...
        tr
         ...
         td H
         td Wb/A
         td [(kg·m<sup>2</sup>)/(A·s<sup>2</sup>)]/A <br> (kg·m<sup>2</sup>)/(A<sup>2</sup>·s<sup>2</sup>)
        ...
        tr
         td Actividad de un radionúclido 
         td Becquerel
         td Bq
         td 
         td s<sup>-1</sup>
        ...
        tr
         td Dosis absorbida, energía másica, kerma 
         td Gray
         td Gy
         td J/kg
         td [kg·m<sup>2</sup>/s<sup>2</sup>]/kg <br> m<sup>2</sup>/s<sup>2</sup>  

        tr
         td Dosis equivalente, equivalente de dosis ambiental, equivalente de dosis direccional, equivalente de dosis individual, dosis equivalente en un organo 
         td Sievert
         td Sv
         td J/kg
         td [kg·m<sup>2</sup>/s<sup>2</sup>]/kg <br> m<sup>2</sup>/s<sup>2</sup> 
        tr
         td Actividad catalítica
         td katal
         td kat
         td 
         td mol/s
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Dimensiones básicas del sistema inglés

      table(style=" font-size: 15px;") 
        tr
          th Magnitud
          th Unidad inglesa
          th Otras unidades inglesas

        tr
         td Longitud
         td ft
         td pulgada (in), milla (mi), yarda (yd) 
        ...
        tr
         td Energía
         td BTU <br>(unidad térmica británica)
         td 

        tr
         td Potencia
         td hp <br>(caballo de fuerza)
         td 

        tr
         td Densidad &rho;
         td slug/ft<sup>3</sup>
         td 

        tr
         td peso especifico &gamma; 
         td lb/ft<sup>3</sup>
         td 
        ...
        tr
         td Esfuerzo, presión
         td lb/in<sup>2</sup> o psi
         td kip/in<sup>2</sup> o ksi
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Comparación entre sistemas

      table(style=" font-size: 15px;") 
        tr
          th 
          th(colspan="5").center Sistema
        ...
        tr
         td Presión
         td dina/cm<sup>2</sup>
         td Pa
         td kg<sub>f</sub>/m<sup>2</sup>
         td lb
         td atm o lb
    ...
    slide(:steps=0, enter='bounceInDown' :mouseNavigation='false' style="overflow: scroll;")
      .top <sup style="font-size: 10px;">{{ currentSlideIndex }}/{{ slides.length }}  : {{ theme }}</sup>
      h4(style="margin-top: -20px; color: green;").center Prefijos usados con las unidades del SI
      ...
      table(style=" font-size: 15px;") 
        ...
        tr
         td quetta
         td Q
         td 10<sup>27</sup> = 1000 000 000 000 000 000 000 000 000 000

        tr
         td ronna
         td R
         td 10<sup>27</sup> = 1000 000 000 000 000 000 000 000 000

        tr
         td yotta 
         td Y
         td 10<sup>24</sup> = 1000 000 000 000 000 000 000 000

        tr
         td zetta
         td Z
         td 10<sup>21</sup> = 1000 000 000 000 000 000 000

        tr
         td exa
         td E
         td 10<sup>18</sup> = 1000 000 000 000 000 000

        tr
         td peta
         td P
         td 10<sup>15</sup> = 1000 000 000 000 000

        tr
         td tera
         td T
         td 10<sup>12</sup> = 1000 000 000 000

        tr
         td giga 
         td G
         td 10<sup>9</sup> = 1000 000 000

        tr
         td Mega
         td M
         td 10<sup>6</sup> = 1000 000

        tr
         td kilo
         td k
         td 10<sup>3</sup> = 1000
        ...
        tr
         td centi
         td c
         td 10<sup>-2</sup> = 0.01

        tr
         td mili
         td m
         td 10<sup>-3</sup> = 0.001

        tr
         td micro
         td &mu;
         td 10<sup>-6</sup> = 0.000 001

        tr
         td nano
         td n
         td 10<sup>-9</sup> = 0.000 000 001

        tr
         td pico
         td p
         td 10<sup>-12</sup> = 0.000 000 000 001

        tr
         td femto
         td f
         td 10<sup>-15</sup> = 0.000 000 000 000 001

        tr
         td atto
         td a
         td 10<sup>-18</sup> = 0.000 000 000 000 000 001

        tr
         td zepto
         td z
         td 10<sup>-21</sup> = 0.000 000 000 000 000 000 001

        tr
         td yocto
         td y
         td 10<sup>-24</sup> = 0.000 000 000 000 000 000 000 001

        tr
         td ronto
         td R
         td 10<sup>-27</sup> = 0.000 000 000 000 000 000 000 000 001


        tr
         td quecto
         td Q
         td 10<sup>-30</sup> = 0.000 000 000 000 000 000 000 000 000 001
...
export default {
  ...
  infos: {
    title: 'Mecanica, propedeutico',
    description: 'Mecanica',
    path: 'MecanicaPrope',
    course: 'Mecanica, propedeutico',
    part: 1
  },
  components: {
    ...
    'demo-dist': require('./components/demoDistancia'),
    'demo-dist-conclusion': require('./components/distPointConclusion'),
    'coord-bidim': require('./components/coordBidimensional'),
    'distancia-formula-bidim': require('./components/distanciaFormulaBidim'),
    'demo-dist-bidim': require('./components/demoDistBidim'),
    'demo-dist-catetos': require('./components/demoDistCatetos'),
    'demo-dist-bidim-conclusion': require('./components/distPointBidimConclusion'),
  ...
  data: function () {
    return {
      ...
      topics: ['Inicio', 'Temas', 'Sistemas de unidades', 'Trigonometria', 'Cinemática'],
