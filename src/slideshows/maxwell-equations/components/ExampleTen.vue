...
eg-transition(:enter='enter', :leave='leave')
  .eg-slide-content
    p.problem En el circuito, la batería tiene una fem de 12,0 V, la inductancia es de 2,81 mH y la capacitancia es de 9,00 pF. El interruptor se ha mantenido en la posición a durante un tiempo prolongado para cargar el capacitor. Luego, el interruptor se cambia a la posición b, desconectando la batería del circuito y conectando el capacitor directamente en paralelo con el inductor.<br>(A) Calcule la frecuencia de oscilación del circuito.<br>(B) ¿Cuáles son los valores máximos de carga en el capacitor y de corriente en el circuito?An electric toothbrush has a base designed to hold the toothbrush handle when not in use.<br>The handle has a cylindrical hole that fits loosely over a matching cylinder on the base.<br>When the handle is placed on the base, a changing current in a solenoid inside the base cylinder induces a current in a coil inside the handle.<br>This induced current charges the battery in the handle.<br>We can model the base as a solenoid of length l with N<sub>B</sub> turns, carrying a current I, and having a cross-sectional area A. The handle coil contains N<sub>H</sub> turns and completely surrounds the base coil. Find the mutual inductance of the system.

    .center
      img(src="../assets/fig32-9.png")
    //- .center
